...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_vexpr = 20,                     /* vexpr  */
  YYSYMBOL_scalar = 21,                    /* scalar  */
  YYSYMBOL_vector = 22,                    /* vector  */
  YYSYMBOL_num = 23,                       /* num  */
  YYSYMBOL_opt_comma = 24,                 /* opt_comma  */
  YYSYMBOL_numlist = 25                    /* numlist  */
};
...
static const char *const yytname[] =
{
  ...
  "'-'", "'*'", "UMINUS", "'\\n'", "'='", "'('", "')'", "'|'", "'['",
  "']'", "','", "$accept", "input", "line", "vexpr", "scalar", "vector",
  "num", "opt_comma", "numlist", YY_NULLPTR
};
...
{
     -11,     9,   -11,    -4,   -11,    25,    33,   -11,    27,    27,
       1,   -11,    55,    20,   -11,   -11,   -11,    27,   -11,    39,
     -11,   -11,    51,    14,    42,    30,    40,   -11,   -11,    38,
      27,    27,    39,   -11,    27,   -11,    60,    47,   -11,   -11,
     -11,   -11,   -11,   -11,    11,    44,    44,   -11,   -11,   -11,
     -11
};
...
{
       2,     0,     1,     0,    22,    10,     0,     7,     0,     0,
       0,     3,     0,     0,     9,    16,     8,     0,    22,     0,
      17,    10,     0,     0,     0,     0,     0,    20,    26,    24,
       0,     0,     0,     4,     0,     5,     0,     0,    15,    19,
      18,    23,    21,    25,     0,    11,    12,    14,    13,     6,
      27
};
...
{
     -11,   -11,   -11,    -6,     0,   -11,   -10,   -11,   -11
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,    11,    12,    25,    14,    15,    44,    29
};
...
{
      28,    13,    22,    24,     4,    16,    20,    26,    23,     2,
       3,    36,     4,     5,     4,     6,    27,    26,     7,    37,
       8,    34,     9,    10,    45,    46,    39,    34,    48,    35,
       4,    21,    47,     6,    50,    17,    18,    34,     8,     6,
       9,    10,     4,    41,    19,     6,     9,    30,    31,    32,
      19,    32,     9,    42,    43,    40,    30,    31,    32,    39,
      30,    31,    32,    38,    33,    30,    31,    32,     0,    49
};

static const yytype_int8 yycheck[] =
{
      10,     1,     8,     9,     3,     9,     6,     6,     8,     0,
       1,    17,     3,     4,     3,     6,    15,     6,     9,    19,
      11,     7,    13,    14,    30,    31,    12,     7,    34,     9,
       3,     4,    32,     6,    44,    10,     3,     7,    11,     6,
      13,    14,     3,     3,    11,     6,    13,     5,     6,     7,
      11,     7,    13,    15,    16,    13,     5,     6,     7,    12,
       5,     6,     7,    12,     9,     5,     6,     7,    -1,     9
};
...
{
       0,    18,     0,     1,     3,     4,     6,     9,    11,    13,
      14,    19,    20,    21,    22,    23,     9,    10,     3,    11,
      21,     4,    20,    21,    20,    21,     6,    15,    23,    25,
       5,     6,     7,     9,     7,     9,    20,    21,    12,    12,
      13,     3,    15,    16,    24,    20,    20,    21,    20,     9,
      23
};
